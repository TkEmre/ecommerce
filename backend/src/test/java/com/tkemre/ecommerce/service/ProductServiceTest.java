...
class ProductServiceTest {
    ...
    void createProduct_successful() {
        CreateProductRequest request = new CreateProductRequest("Product A", "Category A", BigDecimal.valueOf(100), 10, null);
    ...
    void createProduct_alreadyExists_throwsException() {
        CreateProductRequest request = new CreateProductRequest("Product A", "Category A", BigDecimal.TEN, 10, null);
    ...
    void updateProduct_successful() {
        ...
        UpdateProductRequest request = new UpdateProductRequest("New Name", "Cat", BigDecimal.valueOf(50), 15, true, null);
    ...
    void updateProduct_nameConflict_throwsException() {
        ...
        UpdateProductRequest request = new UpdateProductRequest("New Name", "Cat", BigDecimal.TEN, 5, true, null);
